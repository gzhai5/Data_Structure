...
//   cout<<"height = "<<result.height();
//   REQUIRE( 200 == result.height() );
  
// }

// TEST_CASE("Image scale(720, 10000) results in the correct width/height", "[weight=1][part=1]") {
//   Image img = createRainbowImage();
  
//   Image result = createRainbowImage();
//   result.scale(720, 10000);

//   REQUIRE( 720 == result.width() );
// }
