...
class Shape : public Drawable
{
  ...
  public:
    ...
    virtual ~Shape()  //modified 2/24/2021, + virtual, ex2
    { /* Nothing */
    }
     ...
     */
    virtual int area() const;     //modified 2/24/2021, + virtual, ex1
     ...
     */
    virtual int perimeter() const;    //modified 2/24/2021, + virtual, ex1
